...
namespace SolutionCreator.Infra.Settings
{
    public class SettingsReader : ISettingsReader
    {
        private readonly string _configurationFilePath = "solutionCreator.json";
        private readonly string _sectionNameSuffix = "Settings";
